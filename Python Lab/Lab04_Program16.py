...
# (usage of specific modules such as statistics is not allowed. Lab problems are for you to build-up logic and strengthen your
#  understanding of the topic & its concepts).
