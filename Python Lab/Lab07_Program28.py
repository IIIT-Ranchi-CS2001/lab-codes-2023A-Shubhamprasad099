...
# Plot both prime numbers Vs their squares and composites Vs their square roots on the same figure object as scatterplots. 
# ( two different subplots on the same figure object)
